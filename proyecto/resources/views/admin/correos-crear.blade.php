...
<html lang="{{ config('app.locale') }}">
	...
	<body>
		<div class="container">
			...
			<form name="formulario" id="formulario" action="{{ URL::to('/admin159753/correos-crear') }}" method="post">
				{{ csrf_field() }}
				...
				<div class="form-group">
					<input type="email" class="form-control" id="correo_1" name="correo_1" placeholder="Email" required>
				</div>
				<div class="form-group">
					<input type="email" class="form-control" id="correo_2" name="correo_2" placeholder="Email">
				</div>
